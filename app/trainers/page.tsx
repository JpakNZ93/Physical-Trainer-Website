    ...
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        <div className="grid items-start gap-12 lg:grid-cols-2">
          ...
          <div>
            <h1 className="text-3xl font-black uppercase tracking-wide text-brand-orange md:text-4xl">
              Meet Your Coach
            </h1>
            ...
            <div className="mt-8">
              <h3 className="mb-4 text-lg font-bold uppercase tracking-wider text-brand-orange">
                Qualifications
              </h3>
